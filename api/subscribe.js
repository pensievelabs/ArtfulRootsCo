...
// Download links are temporarily removed.
// When ready, add Google Drive file IDs here and pass them to buildWorksheetEmail().
...
module.exports = async function handler(req, res) {
  ...
  try {
    const { data: emailData, error: emailError } = await resend.emails.send({
      from:    'Artful Roots Co. <worksheets@artfulroots.co>',
      to:      [cleanEmail],
      subject: 'Your Clean Reader phonics worksheets',
      html:    buildWorksheetEmail(cleanEmail),
    });
