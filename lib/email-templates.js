  ...
  <div style="max-width:540px;margin:30px auto;background:#FDFBF7;
    ...
    <div style="font-family:Georgia,serif;font-size:16px;color:#4A4540;
      ...
      <div style="display:flex;gap:12px;margin-bottom:32px;">
        <a href="https://apps.apple.com/us/app/clean-reader-learn-to-read/id6759177993" 
           style="font-family:sans-serif;font-size:14px;color:#C4694A;text-decoration:none;font-weight:500;margin-right:20px;">
          Download for iOS →
        </a>
        <a href="https://play.google.com/store/apps/details?id=com.cleanreader.app" 
           style="font-family:sans-serif;font-size:14px;color:#C4694A;text-decoration:none;font-weight:500;">
